...
public class Usuario {
    ...
    public static String inserirCliente(Usuario cliente){
    ...
    public static String alterarCliente(Usuario cliente){
    ...
    public Usuario(String cpf, String nome, String rg, String nascimentoData, String sexo, String email, String telefone, String celular, Endereço endereço){
        this.cpf = cpf;
        this.nome = nome;
        this.rg = rg;
